...
def main():
    ...
    parser.add_argument("--dataset_file", type=str, default="", help="Output HDF5 dataset path. Empty means task preset default.")
        ...
        while simulation_app.is_running() and not should_exit:
            ...
            if sim_step_count % control_decimation == 0:
                ...
                with torch.inference_mode():
                    ...
                    # Se3KeyboardCfg 已经应用了灵敏度，这里不再二次缩放，避免操作迟滞。
